...
export default function PerspectiveMarqueeHero() {
  const PHONE_NUMBER = "9078738600";

  const handleHireMeClick = () => {
    const message = `Hi Shiv,\n\nI saw your portfolio and I am interested in collaborating with you on a project!\n\nLet's connect and discuss the details.`;
      ...
      <div className="relative z-20 max-w-4xl mx-auto px-6 text-center flex flex-col items-center justify-center mt-4">
        ...
        <div className="mt-10 flex flex-wrap items-center justify-center gap-4">
          <button
            ...
            className="px-7 py-3 rounded-full bg-white text-[#0a0a0c] text-xs font-bold uppercase tracking-wider shadow-lg hover:bg-zinc-200 transition-all duration-300 hover:scale-105 flex items-center gap-2 cursor-pointer"
          >
            <span>Hire Me</span>
          ...
          <button 
            ...
            className="px-7 py-3 rounded-full border border-zinc-800 bg-zinc-950/80 text-zinc-300 text-xs font-semibold uppercase tracking-wider hover:border-zinc-700 hover:text-white transition-all duration-300 hover:scale-105 flex items-center gap-2 cursor-pointer"
          >
